...
public class EventPointer extends GameData implements ICopyable<EventPointer> {
	...
	public void addFields(StrictFieldData fields) throws ParseDataException,
		...
		int ordinal = fields.add(behaviorType == null ? -1 : behaviorType.ordinal(), "behaviorType"); 
		behaviorType = ordinal < 0 ? null : BehaviorType.values()[ordinal];
		behaviorIndex = fields.add(behaviorIndex, "behaviorIndex");
		eventIndex = fields.add(eventIndex, "eventIndex");
	}
